...
import 'package:mywebapp/theme/enum.dart';
...
class AppTheme {
  ...
  static Color get alertDialogTitleColor =>
      isLightMode ? const Color(0xFF0056B3) : const Color(0xFF80CFFF);

  static Color get notificationTimeColor =>
      isLightMode ? const Color(0xFF8C8C8C) : const Color(0xFFB0B0B0);

  static Color get alertDialogBackgroundColor =>
      isLightMode ? const Color(0xFFFFFFFF) : const Color(0xFF1C1C1E);

  static Color get unreadNotificationCardColor =>
      isLightMode ? const Color(0xFFE6F7E6) : const Color(0xFF1B3721);

  static Color get notificationCardColor =>
      isLightMode ? const Color(0xFFF5F5F5) : const Color(0xFF2C2C2C);

  static Color get hotelListCardColor =>
      isLightMode ? const Color(0xFFE0E0E0) : const Color(0xFF424242);

  static Color get roomListCardColor =>
      isLightMode ? const Color(0xFFE0E0E0) : const Color(0xFF424242);
  ...
  static Color get shimmerBaseColor =>
      isLightMode ? const Color(0xFFE0E0E0) : const Color(0xFF333333);

  static Color get shimmerHighLightColor =>
      isLightMode ? const Color(0xFFFAFAFA) : const Color(0xFF4F4F4F);
